...
int sc_main(int argc, char *argv[])
{
  ...
  // In master 3, specify the start address of every ram and block size and
  // finally the master id 3
  New_master master3("master3", 0, 16, 64, 5, 2);
  Ram    ram3("ram3", 64,16);
  Adder  adder("adder");
  Adapter adpt("adpt", 3);
  ...
  // Pass the no of masters as argument. needed for arbitration
  Bus_ca bus("bus", 4);
